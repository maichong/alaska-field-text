...
var TextFieldView = function (_React$Component) {
  ...
  function TextFieldView(props, context) {
    _classCallCheck(this, TextFieldView);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TextFieldView).call(this, props));
  ...
  _createClass(TextFieldView, [{
    ...
    value: function render() {
      ...
      var others = _objectWithoutProperties(_props, ['model', 'data', 'field']);

      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_textField2.default, _extends({ ref: 'input', fullWidth: field.fullWidth, hintText: field.label }, others))
      );
    }
  }]);
...
TextFieldView.contextTypes = {
  muiTheme: _react2.default.PropTypes.object,
  views: _react2.default.PropTypes.object,
  settings: _react2.default.PropTypes.object
};
TextFieldView.childContextTypes = {
  muiTheme: _react2.default.PropTypes.object,
  views: _react2.default.PropTypes.object,
  settings: _react2.default.PropTypes.object
};
TextFieldView.mixins = [_contextPure2.default];
